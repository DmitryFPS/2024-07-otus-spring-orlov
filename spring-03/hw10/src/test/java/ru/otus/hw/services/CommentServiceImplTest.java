...
class CommentServiceImplTest {
    ...
    void testSaveBookComment() {
        final CommentCreateDto expectedComment = new CommentCreateDto(1L, "CommentNew");
        final CommentDto returnedComment = serviceTest.create(expectedComment);
        assertEquals(returnedComment.getCommentText(), expectedComment.getContent());
    }
