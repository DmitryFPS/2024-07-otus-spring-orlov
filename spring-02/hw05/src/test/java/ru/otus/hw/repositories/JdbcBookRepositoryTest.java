...
class JdbcBookRepositoryTest {
    ...
    void shouldReturnCorrectBookById(final Book expectedBook) {
        final Optional<Book> actualBook = repositoryJdbc.findById(expectedBook.getId());
    ...
    void shouldReturnCorrectBooksList() {
        final List<Book> actualBooks = repositoryJdbc.findAll();
    ...
    void shouldSaveNewBook() {
        final Book expectedBook = new Book(0, "BookTitle_10500", dbAuthors.get(0),
                List.of(dbGenres.get(0), dbGenres.get(2)));
        final Book returnedBook = repositoryJdbc.save(expectedBook);
    ...
    void shouldSaveUpdatedBook() {
        final Book expectedBook = new Book(1L, "BookTitle_10500", dbAuthors.get(2),
